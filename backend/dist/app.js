...
const internal_simulator_routes_1 = __importDefault(require("./routes/internal-simulator.routes"));
...
app.use("/internal/simulator", internal_simulator_routes_1.default);
